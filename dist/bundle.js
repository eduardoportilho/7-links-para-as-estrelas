  ...
  _createClass(Wikipedia, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(titles) {
        var endpoint, data, queryResults, mergedResults;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 13:
                mergedResults = this._merge(queryResults);
    ...
    key: '_get',
    value: function _get(titles) {
      var _this = this;

      return new Promise(function (resolve, reject) {
        var endpoint = _this.getQueryEndpoint(titles);
        // console.log(`GET ${endpoint}`)
    ...
    key: '_addContinueParams',
    value: function _addContinueParams(endpoint, continueData) {}
  }, {
    key: '_merge',
    value: function _merge(queryResults) {}
  }, {
    key: '_dataToPages',
