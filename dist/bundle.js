...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(64), __webpack_require__(332)(module)))
...
var setelinksParaAsEstrelas = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(initialTitle, targetTitle) {
    var _this = this;

    var initialPage, foundPaths, depth, pagesInDepth, _loop;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _wikipedia2.default.getPage(initialTitle);

          case 2:
            initialPage = _context2.sent;
            foundPaths = [];
            depth = MAX_DEPTH;
            pagesInDepth = [initialPage];
            _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
              var nextDepthPages, links, allLinkedPages, _loop2, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, page, paths;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      links = pagesInDepth.map(function (page) {
                        return page.links;
                      });
                      _context.next = 4;
                      return _wikipedia2.default.getPages(links);

                    case 4:
                      allLinkedPages = _context.sent;

                      _loop2 = function _loop2(page) {
                        page.linkedPages = page.links.map(function (link) {
                          var linkedPage = _lodash2.default.clone(allLinkedPages[link]);
                          linkedPage.parent = page;
                          return linkedPage;
                        });
                        nextDepthPages = _lodash2.default.concat(nextDepthPages, page.linkedPages);
                      };
                      ...
                      _context.prev = 9;
                      for (_iterator = pagesInDepth[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        page = _step.value;
                    ...
                    case 25:
                      paths = findPaths(nextDepthPages, targetTitle);

                      foundPaths = _lodash2.default.concat(foundPaths, paths);
              ...
              }, _loop, _this, [[9, 13, 17, 25], [18,, 20, 24]]);
            });
  ...
  return function setelinksParaAsEstrelas(_x, _x2) {
...
var _wikipedia = __webpack_require__(333);
...
function findPaths(pages, targetTitle) {
  var lowerTargetTitle = targetTitle.toLowerCase();
  return pages.filter(function (page) {
    return page.title.toLowerCase() === lowerTargetTitle;
...
var Wikipedia = function () {
  ...
  _createClass(Wikipedia, [{
    ...
    key: 'getPages',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(titles) {
        var endpoint, queryResults, allResults, continueEndpoint, mergedResults;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                endpoint = this._getQueryEndpoint(titles);
                _context.next = 3;
              ...
              case 13:
                ...
                return _context.abrupt('return', this._dataToPages(mergedResults));
    ...
    key: '_getQueryEndpoint',
    value: function _getQueryEndpoint(titles) {
    ...
    key: '_addContinueParamsToEndpoint',
    value: function _addContinueParamsToEndpoint(endpoint, continueData) {
      return _lodash2.default.reduce(continueData, function (result, value, key) {
    ...
    value: function _mergeQueryResults(queryResultArray) {
      ...
      try {
        for (var _iterator = queryResultArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          for (var page in queryResults.query.pages) {
            var pageId = page.pageid;
            if (!mergedPages[pageId]) {
              mergedPages[pageId] = page;
            } else {
              mergedPages[pageId].links = _lodash2.default.merge(mergedPages[pageId].links, page.links);
            }
          }
        }
      } catch (err) {
    ...
    value: function _dataToPages(queryResult) {
      var pages = {};
      for (var queryPage in queryResult.query.pages) {
        pages[queryPage.pageid] = {
          id: queryPage.pageid,
          title: queryPage.title,
          links: queryPage.links.map(function (link) {
            return link.title;
          })
        };
      }
...
var debug = __webpack_require__(335)('jsonp');
